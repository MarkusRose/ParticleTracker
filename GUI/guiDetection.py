...
def doSetup():
    ...
    def updateText():
        ...
        if not os.path.isdir(invar12.get()):
            outvar12.set(invar12.get())
        else:
            if tkMessageBox.askyesno("Folder Exists!", "This folder exists. Do you want to copy over its content?"):
                outvar12.set(invar12.get())
            else:
                goodtogo = False
        if outvar12.get()=="":
    ...
    ttk.Button(labelframe, text="Choose", command = lambda:chooseDirectory(invar1)).grid(column=2, row=1, sticky=W)
    #ttk.Entry(labelframe, textvariable = invar1).grid(column=2, row=1, sticky=W)
    ttk.Label(labelframe, textvariable=invar1).grid(column=3, row=1, sticky=W)
    ...
    invar11 = StringVar()
    outvar11 = StringVar()
    ttk.Label(labelframe, text="Initial Positions File").grid(column=1, row=11, sticky=W)
    ttk.Button(labelframe, text="Choose", command = lambda:chooseFile(invar11)).grid(column=2, row=11, sticky=W)
#   ttk.Entry(labelframe, textvariable = invar11).grid(column=2, row=11, sticky=W)
    ttk.Label(labelframe, textvariable=invar11).grid(column=3, row=11, sticky=W)

    invar12 = StringVar()
    outvar12 = StringVar()
    ttk.Label(labelframe, text="Output Folder").grid(column=1, row=12, sticky=W)
#    ttk.Button(labelframe, text="Choose", command = lambda:chooseDirectory(invar12)).grid(column=2, row=12, sticky=W)
    ttk.Entry(labelframe, textvariable = invar12).grid(column=2, row=12, sticky=W)
    ttk.Label(labelframe, textvariable=outvar12).grid(column=3, row=12, sticky=W)
