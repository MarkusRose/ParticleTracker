...
from . import Detection.detectParticles as dp
from . import Detection.readImage
from . import Detection.ctrack
from . import Detection.markPosition
from . import Detection.convertFiles
from . import Detection.analysisTools
from . import Detection.det_and_track
...
if __name__=="__main__":
    ...
    firstImage = Detection.readImage.readImage(images[min(5,len(images)-1)])
    ...
    sys.stdout.flush()
    power_index = input("Which image is the best?")
